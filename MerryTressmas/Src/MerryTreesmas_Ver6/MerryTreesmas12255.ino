...
void drawFoodMenu(void) {           //메뉴를 그리는 함수
  uint8_t i, h;
  u8g_uint_t w, d;
...
void food_menu(void)          //키의 입력에 따라 food_current를 바꿔 표시된 부분에 대비가 되도록 함
{
  switch ( uiKeyCode ) {
  case KEY_NEXT:
    food_current++;
