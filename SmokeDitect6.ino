...
Adafruit_VC0706 cam = Adafruit_VC0706(&Serial1); // 아두이노의 19(RX), 18(TX) 시리얼 포트 사용
...
void setup()
{
  ...
  // 와이파이 접속을 실패하면 무한루프
  if (!cc3000.connectToAP(WLAN_SSID, WLAN_PASS, WLAN_SECURITY)) { //CC3000을 사용한 WIFI설정
